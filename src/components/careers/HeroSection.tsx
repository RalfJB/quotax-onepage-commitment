...
const HeroSection = ({ addToRefs }: HeroSectionProps) => {
  ...
  return (
    ...
    >
      <div className="absolute left-0 top-40 w-80 h-80 bg-green/5 rounded-full -z-10 blur-3xl"></div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-outfit tracking-tighter font-normal mb-6 text-foreground">
