    ...
    <section className="relative min-h-screen w-full overflow-hidden flex flex-col items-center justify-center">
      ...
      >
        <div className="mb-4 lg:mb-6">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-semibold text-gray-800 mb-6">
            Steuerberatung
          </h2>
        </div>
        ...
        <div className="my-12 flex justify-center">
          <div className="flex items-center space-x-4">
            ...
            <span className="text-2xl md:text-3xl font-medium text-gray-700">.</span>
          </div>
        </div>
