    ...
    <section className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center px-6 md:px-12 lg:px-24">
      ...
      <div className="z-10 max-w-4xl text-center animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
        ...
        <h1 className="font-display text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-6 text-balance leading-tight">
          ...
          <br/>
          <div className="mt-2">
            <span className="text-purple bg-white/40 backdrop-blur-sm px-2 py-1 rounded">Digital</span>
            {" "}und{" "}
            <span className="text-green bg-white/40 backdrop-blur-sm px-2 py-1 rounded">persönlich</span>.
          </div>
        </h1>
        <p className="text-lg md:text-xl text-gray-700 max-w-2xl mx-auto mb-10 text-balance bg-white/60 backdrop-blur-sm p-4 rounded-lg">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
          ...
          <a 
            href="#services" 
            className="px-8 py-4 border border-gray-300 bg-white/50 backdrop-blur-sm rounded-lg font-medium transition-all duration-300 hover:shadow-md hover:border-purple hover:text-purple flex items-center gap-2 w-full sm:w-auto justify-center group"
          >
